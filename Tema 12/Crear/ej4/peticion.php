<?php
$url="http://localhost//PHP/PHP/Tema%2012/Crear/ej4/servicioEscuela.php";
//Los 3 primeros al ser GET se ejecutan como siempre
...
//Para POST PUT y DELETE hay que mandarle los datos en la cabecera a la hora de hacer la peticion en la function hacerPeticion      
...
function hacerPeticion ($datos, $metodo, $url){
    //Configuramos las opciones de la cabecera en $opciones y lo convertimos en contexto para mandarlo a la url con file get contents
    $opciones = [
        "http" => [
